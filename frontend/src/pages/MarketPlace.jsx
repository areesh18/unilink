...
const ListingCard = ({ listing }) => {
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden transform transition duration-300 hover:scale-105">
            ...
            <div className="p-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1 truncate">{listing.title}</h3>
        ...
        <div className="space-y-6">
            ...
            {!isLoading && !error && (
                <>
                    {listings.length === 0 ? (
                        <div className="text-center py-10">
                             <p className="text-gray-500 dark:text-gray-400">No listings found in your college yet.</p>
                        </div>
                    ) : (
